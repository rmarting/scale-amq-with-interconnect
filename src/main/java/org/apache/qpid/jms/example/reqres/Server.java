...
public class Server {
	...
	public static void main(String[] args) throws Exception {
    	try {
            ...
            ConnectionFactory factory = (ConnectionFactory) context.lookup("requestResponseServerFactory");
            ...
            System.out.println("[SERVER] Connected to " + ((JmsConnection) connection).getConfiguredURI());

            Destination queue = (Destination) context.lookup("requestQueue");
            MessageConsumer messageConsumer = session.createConsumer(queue);
            MessageProducer messageProducer = session.createProducer(null);
            
            System.out.println("[SERVER] Ready to accept messages from clients");
